        ...
        while(menu) {
            ...
            if (nama.equals("Exit")){menu = false;}
                ...
                for (Pelanggan i: Main.customers){
                    if (i.getCustomerName().equals(nama)){JOptionPane.showMessageDialog(null, c.printCustomerTransaction(i), "Data Transaksi " + i.getCustomerName(), JOptionPane.INFORMATION_MESSAGE); break;}
                };
            }
        }
    }
